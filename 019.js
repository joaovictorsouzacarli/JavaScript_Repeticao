...
// iniciando em R$1 no primeiro dia e aumentando esse valor em R$1 a cada novo dia. Ou seja, 
// a cada dia que passa, ela economiza R$1 a mais do que no anterior.
...
for (let i = 0; i < totalDias; i++) {
    economia = economia + dia
}

console.log('Economia Total:', economia)